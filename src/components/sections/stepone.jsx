    ...
    <div className={styles.form}>
      ...
      <form method="GET">
        ...
        <div>
            ...
            <label htmlFor="agree">I agree to all the <a href="https://www.privacypolicies.com/live/228b4da0-e337-48b7-b9e8-02a7d2d1347a" target="_blank" style={{color:'inherit', textDecoration: 'none'}}><span>terms and privacy policy</span></a> of Fin-traka</label> 
        </div>
